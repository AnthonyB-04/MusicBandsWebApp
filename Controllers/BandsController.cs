...
namespace MusicBandsWebApp.Controllers
{
    public class BandsController : Controller
    {
        ...
        public BandsController(DBMusicBandsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BandId,BandName,Info")] Band band)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BandId,BandName,Info")] Band band)
        {
            if (id != band.BandId)
            {
                return NotFound();
