...
namespace MusicBandsWebApp.Controllers
{
    public class MusiciansController : Controller
    {
        ...
        public MusiciansController(DBMusicBandsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MusicianId,Name,Year,Role")] Musician musician)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MusicianId,Name,Year,Role")] Musician musician)
        {
